...
def setupTexturePlane(bgImageFolder):
    ...
    bpy.data.objects['Box'].data.materials[0].blend_method = 'CLIP'
    bpy.data.objects['Box'].data.materials[0].shadow_method = 'CLIP'
    bpy.data.objects['Box'].data.materials[0].alpha_threshold = 1.0
