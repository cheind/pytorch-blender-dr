...
if __name__ == '__main__':
    ...
    DLASeg: 220 layers, 18.5M parameters, 18.5M gradients, 62.1GFLOPs
    benchmark warm up...
    Forward time: 10.533ms (cuda) @ input: torch.Size([1, 3, 512, 512])
    ...
    Forward time: 46.981ms (cuda) @ input: torch.Size([16, 3, 512, 512])
    Backward time: 286.271ms (cuda) @ input: torch.Size([16, 3, 512, 512])
    Maximum of managed memory: 8.896118784GB
    ...
    DLASeg: 220 layers, 18.5M parameters, 18.5M gradients, 62.1GFLOPs
    benchmark warm up...
    Forward time: 10.001ms (cuda) @ input: torch.Size([1, 3, 512, 512])
    benchmark warm up forward...
    benchmark warm up backward...
    run through forward pass for 100 runs...
    run through forward and backward pass for 100 runs...
    Forward time: 114.778ms (cuda) @ input: torch.Size([32, 3, 512, 512])
    Backward time: 640.018ms (cuda) @ input: torch.Size([32, 3, 512, 512])
    Maximum of managed memory: 15.430844416GB
    """
